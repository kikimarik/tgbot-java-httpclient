...
public class SendAnimation implements ApiMethodWithBodyInterface {

    private final String httpMethod;
    private String body;

    public SendAnimation(String httpMethod) {
    ...
    public String send(String token) throws IOException, InterruptedException {
        return this.serviceLocator.getClient()
                ...
                .setBodyMap(
                        this.serviceLocator
                                .getJsonTranslator()
                                .toHashMap(api.entities.methods.SendAnimation.class, this.body)
                )
